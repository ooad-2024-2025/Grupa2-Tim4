...
namespace Aplikacija.Data.Migrations
{
    ...
    [Migration("20250610155256_12taMigracija")]
    partial class _12taMigracija
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aplikacija.Models.Obrok", b =>
                {
                    b.Property<int>("IdObrok")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdObrok"));
            ...
            modelBuilder.Entity("Aplikacija.Models.Obrok", b =>
                {
                    b.HasOne("Aplikacija.Models.PlanIshrane", "PlanIshrane")
                        .WithMany("Obroci")
